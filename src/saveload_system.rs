...
pub fn save_game(ecs: &mut World) {
        ...
        .build();
    {
        ...
        serialize_individually!(
            ...
            WantsToDropItem, SerializationHelper, Equippable, MeleePowerBonus, DefenseBonus, WantsToRemoveItem, ParticleLifetime, HungerClock, ProvidesFood, MagicMapper, Hidden, EntryTrigger, EntityMoved, SingleActivation
        );
    }
